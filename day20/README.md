...
- `ENNWSWWSSSEENEENNN`
- <code>ENNWSWW<strong>NEWS</strong>SSSEENEENNN</code>
- <code>ENNWSWW<strong>NEWS</strong>SSSEENEE<strong>SWEN</strong>NNN</code>
- <code>ENNWSWWSSSEEN<strong>WNSE</strong>EENNN</code>
